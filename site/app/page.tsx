  ...
  return (
    <>
      ...
      <div className="wrap">
        ...
        <p>Real-time spend tracking, validated against live infrastructure, distinguishes between cost control (a hard budget ceiling per agent) and availability control (rate limiting), a distinction most agentic demos miss entirely. The budget cap protects the wallet. It does not, by itself, protect against a bot exhausting an agent&apos;s capacity in minutes. Both layers exist here, deliberately, for that reason.</p>
